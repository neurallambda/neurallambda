        ...
        for k in lor_ix_keys:  # eg ['lor_qs', 'lor_ks', 'lor_vs', ...]
            for batch_ix, sample in enumerate(column):  # iter each data sample
                ...
                for layer_ix, parse_ixs in enumerate(per_layer_parse_ixs):
                    ...
                    layer_batch_left_lor_ixs[layer_ix][batch_ix]  = parse_ixs[0]
                    layer_batch_right_lor_ixs[layer_ix][batch_ix] = parse_ixs[1]
...
def create_dataloader(
    ...
    return DataLoader(
        ...
        collate_fn=lambda batch: create_column_batch_inputs(batch, num_layers, lor_ix_keys, tokenizer, device)
    )
